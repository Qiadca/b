        ...
        <div class="text">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('front.blogs') }}">Bloglar</a></li>
                ...
                <div class="col-md-8">
                    <div class="single-section">
                        ...
                        <div class="text">
                            ...
                            <h3>
                              Yayınlanan: {{ \Carbon\Carbon::parse($blog_detail->created_at)->format('d M, Y') }}
                            </h3>
                            {!!  $blog_detail->blog_content !!}
                        </div>

                        <h2 class="mt_35">Bunu Paylaş</h2>
                        ...
                        <div class="comment mt_50">
                            ...
                            <h2 class="mb_40">Yorumlar ({{ count($comments) }})</h2>

                            @if(count($comments) == 0)
                                <div class="text-danger">Yorum Bulunamadı</div>
                            @else
                            ...
                            <h2 class="mt_35">Yorumunu Gönder</h2>
