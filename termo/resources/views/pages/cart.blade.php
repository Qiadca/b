                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ url('cart/update') }}" method="post">
                            ...
                            <table class="table table-bordered">
                                ...
                                @for($i=1;$i<=count($arr_cart_product_id);$i++)
									...
									{{--<td class="align-middle">{{ $i }}</td>--}}
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ url('product/'.$product_slug) }}" id="pro-name">{{ $product_name }}</a>
                                        </td>
						...
						{{--  <div class="cart-buttons">
                            <a href="{{ route('front.shop') }}" class="btn btn-info btn-arf">Alışverişe Devam</a>
                            <input type="submit" value="Update Cart" class="btn btn-info btn-arf" name="form1">
                            <a href="{{ route('front.checkout') }}" class="btn btn-info btn-arf">Ödeme</a>
                        </div>
						--}}
                    </form>
