    ...
    <div class="text">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item"><a href="{{ route('front.team_members') }}">Ekip Üyeleri</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="description mt_30">
                    <ul class="nav nav-pills mb-3 nav-doctor" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-tab-1" data-toggle="pill" href="#pills-t-1" role="tab" aria-controls="pills-t-1" aria-selected="true">Derece</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tab-2" data-toggle="pill" href="#pills-t-2" role="tab" aria-controls="pills-t-2" aria-selected="false">Detaylar</a>
                        </li>
                        <li class="nav-item">
