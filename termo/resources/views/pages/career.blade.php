                    ...
                    <div class="career">
                        ...
                        <div class="career-main-item">
                            ...
                            <div class="row long">
                                ...
                                <div class="col-md-4">
                                    <a href="{{ url('job/'.$row->job_slug) }}" class="btn btn-success btn-sm btn-block">Ayrıntılara Bakınız</a>
                                </div>
                                <div class="col-md-4">
                                    <a href="{{ url('job/apply/'.$row->job_slug) }}" class="btn btn-danger btn-sm btn-block">Şimdi Uygula</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
