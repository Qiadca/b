        ...
        <div class="text">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Ansayafa</a></li>
            ...
            <div class="row cart">
                <div class="col-md-12 faq">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <button type="submit" class="btn btn-primary btn-block">Kuponu Onayla</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="customer-info mb_30">                       
                            <div class="form-check mt_10 mb_10">
                                ...
                                <label class="form-check-label" for="returning_customer_action">
                                    Geri Dönen Müşteri? Giriş yapmak için buraya tıklayın                           
                                </label>
                            </div>
                    ...
                    <form action="{{ route('customer.billing_shipping_submit') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-primary">Ödeme Devam</button>
                    </form>
