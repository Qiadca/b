...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Blog'u Düzenle</h1>
    ...
    <form action="{{ url('admin/blog/update/'.$blog->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Blog'u Düzenle</h6>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="">Mevcut Blog Fotoğafı</label>
                    <div>
                        <img src="{{ asset('public/uploads/'.$blog->blog_photo) }}" alt="" class="w_200">
                    </div>
                </div>
                <div class="form-group">
                    <label for="">Blog Fotoğafını Değiştir</label>
                    <div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="">Meta Açıklamsı</label>
