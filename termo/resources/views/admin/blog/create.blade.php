...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Blog Ekle</h1>

    <form action="{{ route('admin.blog.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Blog Ekle</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.blog.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Hepsini Görüntüle</a>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="">Abonelere e-posta göndermek ister misiniz? *</label>
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="send_email_to_subscribers" id="rr1" value="Yes" checked>
                            <label class="form-check-label font-weight-normal" for="rr1">Evet</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="send_email_to_subscribers" id="rr2" value="No">
                            <label class="form-check-label font-weight-normal" for="rr2">Hayır</label>
                        </div>
                    </div>
                </div>
            </div>
