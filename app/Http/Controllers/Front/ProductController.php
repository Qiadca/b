...
class ProductController extends Controller
{
    public function index()
    {
        ...
        $products = DB::table('products')->orderBy('product_order', 'asc')->where('product_status', 'Show')->paginate(100);
    ...
    public function add_to_cart(Request $request)
    {
        ...
        if(session()->has('cart_product_id'))
        {
            ...
            if(in_array($product_id,$arr_cart_product_id)) {
                return redirect()->back()->with('error', 'Ürün Sepetinize Zaten Eklendi');
            }
        }
        ...
        return redirect()->back()->with('success', 'Ürün Sepetinize Başarıyla Eklendi!');
    }
