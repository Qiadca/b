...
Route::get('hizmetlerimiz', [ServiceControllerForFront::class,'index'])->name('front.services');
Route::get('hizmetlerimiz/{slug}', [ServiceControllerForFront::class,'detail']);
...
Route::get('araclarimiz', [ProjectControllerForFront::class,'index'])->name('front.projects');
Route::get('araclarimiz/{slug}', [ProjectControllerForFront::class,'detail']);
...
Route::get('iletisim', [ContactController::class,'index'])->name('İletişim');
Route::post('iletisim/store', [ContactController::class,'send_email'])->name('front.contact_form');
...
Route::get('sartlar-ve-kosullar', [TermController::class,'index'])->name('front.term');
Route::get('gizlilik-politikasi', [PrivacyController::class,'index'])->name('front.privacy');
...
Route::post('customer/process-payment', [CheckoutController::class, 'processPayment'])->name('processPayment');
...
Route::get('/randevu-al', [App\Http\Controllers\AppointmentController::class, 'create'])->name('appointment.create');
Route::post('/randevu-al', [App\Http\Controllers\AppointmentController::class, 'store'])->name('appointment.store');
