        ...
        <div class="text">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Müşteri Kaydı</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="reg-login-form">
                        <div class="inner">
                            <form action="{{ route('customer.registration.store') }}" method="post">
                                ...
                                <button type="submit" class="btn btn-primary btn-arf">Kayıt Yap</button>
                                <div class="new-user">
                                    <a href="{{ route('customer.login') }}">Varolan kullanıcı? Giriş Sayfasına Git</a>
                                </div>
                            </form>
                        </div>
                    </div>
