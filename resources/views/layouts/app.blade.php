...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    @if($conName[0] == 'about')
        ...
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description ?? 'Hakkımızda' }}">
        <title>{{ $item_row->seo_title ?? 'Hakkımızda' }}</title>
    @endif
    ...
    @if($conName[0] == 'services')
        ...
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description ?? 'Hizmetler' }}">
        <title>{{ $item_row->seo_title ?? 'Hizmetler' }}</title>
    @endif
    ...
    @if($conName[0] == 'shop')
        ...
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description ?? 'Ürünlerimiz' }}">
        <title>{{ $item_row->seo_title }}</title>
    @endif
    ...
    @if($conName[0] == 'product')
        ...
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description ?? 'Ürünlerimiz' }}">
        <title>{{ $item_row->seo_title ?? 'Ürünlerimiz' }}</title>
        @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item footer-service">
                    <img id="footer-logo" src="{{ asset('public/uploads/'.$g_setting->logo) }}" alt="">
                    <div class="footer-item footer-contact">
                        {{-- <p>{{ $g_setting->footer_column3_heading }}</p> --}}
                        <ul>
...
<div class="row footer-end col-md-12">
    <p class="footer-p">{{ $g_setting->footer_copyright }}</p>
    <div class="col-md-6">
        <div class="footer-pages">
            <ul>
                <li><a href="{{ route('front.term') }}">Şartlar ve Koşullar</a></li>
                <li><a href="{{ route('front.privacy') }}">Gizlilik Politikası</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="extra-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2></h2>
                <p>COPYRIGHT © 2024 ALPHA | DESIGN BY Alp</p>
            </div>
        </div>
    </div>
</div>
