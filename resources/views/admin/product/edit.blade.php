...
<div class="form-group">
                            ...
                            <select name="product_category" class="form-control">
							        @if($product->product_category == 'Canulla')
								    <option value="Canulla">Burger </option>
									<option value="PVA">Yan Ürünler </option>
									<option value="DCR">Tatlılar </option>
									<option value="CXL">İçecekler </option>								
									@endif
									
                                    @if($product->product_category == 'PVA')
										<option value="PVA">Yan Ürünler </option>
									<option value="Canulla">Burger </option>
									<option value="DCR">Tatlılar </option>
									<option value="CXL">İçecekler </option>							
                                    ...
                                    @if($product->product_category == 'DCR')
										<option value="DCR">Tatlılar </option>
										<option value="PVA">Yan Ürünler </option>
									<option value="Canulla">Burger </option>
									<option value="CXL">İçecekler </option>	
									...
									@endif
									 @if($product->product_category == 'CXL')
										 <option value="CXL">İçecekler </option>
										<option value="DCR">Tatlılar </option>
										<option value="PVA">Yan Ürünler </option>
									<option value="Canulla">Burger </option>			
