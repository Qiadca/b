                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Şifreyi Sıfırla</h1>
                                        </div>
                                        ...
                                        <form action="{{ route('admin.forget_password.store') }}" class="user" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block">Doğrulama Bağlantısını Gönder</button>
                                        </form>
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="{{ route('admin.login') }}">Anasayfaya Dön</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
